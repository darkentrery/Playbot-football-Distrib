...
export default function BoardCreateEventComponent ({isAuth, openCreateEvent, openCreateEventUnAuth, setEvent}) {
    ...
    return (
        <div className={"board-create-event-component"}>
            <div className={"board-create-event-1280"}>
                ...
                <span className={"elem elem-3 btn"} onClick={getOpenCreateEvent}><div className={"white-ball-icon"}></div>Создать событие</span>
            </div>

import { ButtonsBoardOrganizerComponent } from "../../components/body/ButtonsBoardOrganizerComponent";
import {
    event,
    editEventWindow,
    cancelEventWindow,
...
import {connect} from "react-redux";
  ...
  const VisibleEventOrganizerButtons = connect(
    mapStateToProps,
    mapDispatchToProps
  )(ButtonsBoardOrganizerComponent);
  
  export default VisibleEventOrganizerButtons;
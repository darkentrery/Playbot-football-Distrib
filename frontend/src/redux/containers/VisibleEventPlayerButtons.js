import { ButtonsBoardPlayerComponent } from "../../components/body/ButtonsBoardPlayerComponent";
import {
    event,
    editEventWindow,
    cancelEventWindow,
...
import {connect} from "react-redux";
  ...
  const VisibleEventPlayerButtons = connect(
    mapStateToProps,
    mapDispatchToProps
  )(ButtonsBoardPlayerComponent);
  
  export default VisibleEventPlayerButtons;
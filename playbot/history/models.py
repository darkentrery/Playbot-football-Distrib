...
class UserEventAction(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name="users_events_actions")
    event = models.ForeignKey(Event, on_delete=models.CASCADE, related_name="users_events_actions")
    ...
    reason = models.ForeignKey(CancelReasons, on_delete=models.CASCADE, related_name="users_events_actions", blank=True, null=True)

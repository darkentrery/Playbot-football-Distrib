...
class User(AbstractUser):
    ...
    big_card_photo = models.ImageField(upload_to="photos", verbose_name="Photo", blank=True, null=True)
    small_card_photo = models.ImageField(upload_to="photos", verbose_name="Photo", blank=True, null=True)
    overlay_photo = models.ImageField(upload_to="photos", verbose_name="Photo", blank=True, null=True)

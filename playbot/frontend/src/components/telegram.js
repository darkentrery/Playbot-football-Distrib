...
(function(window) {
  ...
  function initWidget(widgetEl) {
    ...
    if (widgetId = widgetEl.getAttribute('data-telegram-post')) {
      ...
      if (widgetEl.hasAttribute('data-onauth')) {
        onInitAuthUser = onAuthUser = window.__parseFunction(widgetEl.getAttribute('data-onauth'), ['user']);
      }
      ...
      if (widgetEl.hasAttribute('data-onunauth')) {
        onUnauth = window.__parseFunction(widgetEl.getAttribute('data-onunauth'));
      }
  ...
  var TelegramLogin = {
    ...
    _auth: function(options, callback) {
      ...
      var popup_url = window.Telegram.Login.widgetsOrigin + '/auth?bot_id=' + encodeURIComponent(options.bot_id) + '&origin=' + encodeURIComponent(location.origin || location.protocol + '//' + location.hostname) + (options.request_access ? '&request_access=' + encodeURIComponent(options.request_access) : '') + (options.lang ? '&lang=' + encodeURIComponent(options.lang) : '') + '&return_to=' + encodeURIComponent(location.href);
    ...
    getAuthData: function(options, callback) {
      ...
      var xhr = getXHR();
      var url = window.Telegram.Login.widgetsOrigin + '/auth/get';
      xhr.open('POST', url);
